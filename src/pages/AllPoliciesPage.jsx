            ...
            {sortedPolicies.map((policy, idx) => (
              ...
              >
                    ...
                    <div className="all-policies__score-ring">
                      <svg viewBox="0 0 48 48" className="all-policies__dial">
                        ...
                        <circle
                          ...
                          fill="none"
                          stroke={
                            policy.coverageScore >= 80
                              ? "#2ecc71"
                              : policy.coverageScore >= 60
                                ? "#f39c12"
                                : "#e74c3c"
                          }
                          strokeWidth="4"
                ...
                <div className="all-policies__info">
                  <h3 className="heading-card" style={{ marginBottom: '4px' }}>{policy.policyOverview?.name || "Unknown Policy"}</h3>
                  <p className="subheading-muted all-policies__provider" style={{ fontSize: '0.9rem' }}>
                    {policy.policyOverview?.provider || "Unknown Provider"}
                  </p>
                </div>
